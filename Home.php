...
<title>Cyber World Technologies-Home</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="kwrd" content="cyber world technologies, cyber, security, hacking, laptop problems, cyber world, cyberworldtechnologies">
<meta name="desc" content="cyber world technologies">
...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center" style="width:8%">
  ...
  <a href="Home" class="w3-bar-item w3-button w3-padding-small w3-black">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    <h1 class="w3-jumbo w3-animate-zoom"><span class="w3-hide-small">Welcome To</span> Cyber World Technologies.</h1>
    <p class="w3-animate-zoom">Just Another Level To Cyber World.</p>
    <img class="w3-round-large" style="width:99%" src="Hompage logo.png" alt="CyberWorldTechnologieslogo" class="w3-image" width="992" height="360">
  </header>
